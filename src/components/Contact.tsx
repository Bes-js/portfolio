        ...
        <div className="flex gap-6 mt-8 flex-wrap justify-center">
          {socialMediaLinks.map((link, index) => (
            <a
              ...
              className="p-4 bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-200 rounded-full shadow-lg hover:shadow-2xl transition duration-500 flex flex-col items-center justify-center gap-2 hover:-translate-y-48 hover:dark:-translate-y-48"
            >
